...
call mvn -B -Dbenchmark.poolSize=10 -Dbenchmark.executorServiceType=jsr166e-forkjoin-pool test >>outX_poolSize10.txt
call mvn -B -Dbenchmark.poolSize=10 -Dbenchmark.executorServiceType=thread-pool test >>outX_poolSize10.txt
