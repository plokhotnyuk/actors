...
mvn -B -Dbenchmark.poolSize=100 -Dbenchmark.executorServiceType=injection-executor test >>outX_poolSize100.txt
...
mvn -B -Dbenchmark.poolSize=100 -Dbenchmark.executorServiceType=abq-thread-pool test >>outX_poolSize100.txt
